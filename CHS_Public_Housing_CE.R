...
# Data Directory: C:\Users\admin\Box Sync\Default Sync Folder\Projects\NSF_CNH\HUD_Analysis\Section8\CHS_AHD.csv

CHS_AHD <- read.csv("C:/Users/admin/Box Sync/Default Sync Folder/Projects/NSF_CNH/HUD_Analysis/Tables_In/CHS_HUD.csv", stringsAsFactors=FALSE)
...
CHS_Census_Poly <- sf:::st_read(dsn = "C:/Users/admin/Box Sync/Default Sync Folder/Projects/NSF_CNH/HUD_Analysis/ShapeFiles_In", layer = "CHS_Census_Tract")
...
#CHS_out_shape  = tempfile(pattern = "CHS_AHD_", tmpdir = "C:/Users/admin/Box Sync/Default Sync Folder/Projects/NSF_CNH/HUD_Analysis/CensusTract_2000", fileext = ".shp")
# Exports to a Shapefile
sf:::st_write(CHS_Census_AHD, "C:/Users/admin/Box Sync/Default Sync Folder/Projects/NSF_CNH/HUD_Analysis/ShapeFiles_Out/CHS_Census_AHD.shp", delete_layer=TRUE)
#Plot to Check 
plot(CHS_Census_AHD[c("Sec_8_Reported")])
...
CHS_TAX_point <- sf:::st_read(dsn = "C:/Users/admin/Box Sync/Default Sync Folder/Projects/NSF_CNH/HUD_Analysis/ShapeFiles_In", layer = "CHS_Tax_Credit")
...
#CHS_out_shape_TAX  = tempfile(pattern = "CHS_AHD_TAX_", tmpdir = "C:/Users/admin/Box Sync/Default Sync Folder/Projects/NSF_CNH/HUD_Analysis/CensusTract_2000", fileext = ".shp")
# Exports to a Shapefile
sf::st_write(CHS_AHD_Tax, "C:/Users/admin/Box Sync/Default Sync Folder/Projects/NSF_CNH/HUD_Analysis/ShapeFiles_Out/CHS_AHD_TAX.shp", delete_layer=TRUE)
#Plot to Check 
...
CHS_AHD_Tax_Sum <- CHS_AHD_Tax %>% group_by(Tract_Num) %>% summarise(Tax_Units_reported = sum(USER_Low_I))
...
CHS_CE_poly <- st_read("C:/Users/admin/Box Sync/Default Sync Folder/Projects/NSF_CNH/HUD_Analysis/ShapeFiles_In/CHS_CE_data.shp")
CHS_CE_poly <- st_transform(CHS_CE_poly, "+proj=longlat +ellps=GRS80 +datum=NAD83 +no_defs")
...
#Export result to a shapefile
#CHS_AHD_Tax_spatial_join_FINAL_shp  = tempfile(pattern = "CHS_AHD_Tax_spatial_join_FINAL_", tmpdir = "C:/Users/admin/Box Sync/Default Sync Folder/Projects/NSF_CNH/HUD_Analysis/CensusTract_2000", fileext = ".shp")
# Exports to a Shapefile
sf::st_write(CHS_AHD_Tax_spatial_join_FINAL, "C:/Users/admin/Box Sync/Default Sync Folder/Projects/NSF_CNH/HUD_Analysis/ShapeFiles_Out/CHS_AHD_Tax_spatial_join_FINAL.shp",  delete_layer=TRUE)
...
write.csv(CHS_AHD_Tax_spatial_join_FINAL_table, "C:/Users/admin/Box Sync/Default Sync Folder/Projects/NSF_CNH/HUD_Analysis/FinalTables_Out/CHS_AHD_Tax_spatial_join_FINAL_table.csv" )
