...
# Data Directory: C:\Users\admin\Box Sync\Default Sync Folder\Projects\NSF_CNH\HUD_Analysis\Section8\ALB_AHD.csv

ALB_AHD <- read.csv("C:/Users/admin/Box Sync/Default Sync Folder/Projects/NSF_CNH/HUD_Analysis/Tables_In/ALB_HUD.csv", stringsAsFactors=FALSE)
...
ALB_Census_Poly <- sf:::st_read(dsn = "C:/Users/admin/Box Sync/Default Sync Folder/Projects/NSF_CNH/HUD_Analysis/ShapeFiles_In", layer = "ALB_Census_Tract")
...
#ALB_out_shape  = tempfile(pattern = "ALB_AHD_", tmpdir = "C:/Users/admin/Box Sync/Default Sync Folder/Projects/NSF_CNH/HUD_Analysis/CensusTract_2000", fileext = ".shp")
# Exports to a Shapefile
sf:::st_write(ALB_Census_AHD, "C:/Users/admin/Box Sync/Default Sync Folder/Projects/NSF_CNH/HUD_Analysis/ShapeFiles_Out/ALB_Census_AHD.shp", delete_layer=TRUE)
#Plot to Check 
...
ALB_TAX_point <- sf:::st_read(dsn = "C:/Users/admin/Box Sync/Default Sync Folder/Projects/NSF_CNH/HUD_Analysis/ShapeFiles_In", layer = "ALB_Tax_Credit")
...
#ALB_out_shape_TAX  = tempfile(pattern = "ALB_AHD_TAX_", tmpdir = "C:/Users/admin/Box Sync/Default Sync Folder/Projects/NSF_CNH/HUD_Analysis/CensusTract_2000", fileext = ".shp")
# Exports to a Shapefile
sf::st_write(ALB_AHD_Tax, "C:/Users/admin/Box Sync/Default Sync Folder/Projects/NSF_CNH/HUD_Analysis/ShapeFiles_Out/ALB_AHD_TAX.shp", delete_layer=TRUE)
#Plot to Check 
...
ALB_AHD_Tax_Sum <- ALB_AHD_Tax %>% group_by(Tract_Num) %>% summarise(Tax_Units_reported = sum(USER_Low_I))
...
ALB_CE_poly <- st_read("C:/Users/admin/Box Sync/Default Sync Folder/Projects/NSF_CNH/HUD_Analysis/ShapeFiles_In/ALB_CE_data.shp")
ALB_CE_poly <- st_transform(ALB_CE_poly, "+proj=longlat +ellps=GRS80 +datum=NAD83 +no_defs")
...
#Export result to a shapefile
#ALB_AHD_Tax_spatial_join_FINAL_shp  = tempfile(pattern = "ALB_AHD_Tax_spatial_join_FINAL_", tmpdir = "C:/Users/admin/Box Sync/Default Sync Folder/Projects/NSF_CNH/HUD_Analysis/CensusTract_2000", fileext = ".shp")
# Exports to a Shapefile
sf::st_write(ALB_AHD_Tax_spatial_join_FINAL, "C:/Users/admin/Box Sync/Default Sync Folder/Projects/NSF_CNH/HUD_Analysis/ShapeFiles_Out/ALB_AHD_Tax_spatial_join_FINAL.shp",  delete_layer=TRUE)
...
write.csv(ALB_AHD_Tax_spatial_join_FINAL_table, "C:/Users/admin/Box Sync/Default Sync Folder/Projects/NSF_CNH/HUD_Analysis/FinalTables_Out/ALB_AHD_Tax_spatial_join_FINAL_table.csv" )
